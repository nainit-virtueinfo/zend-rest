...
class UserControllerTest extends Zend_Test_PHPUnit_ControllerTestCase
{
	...
	{
		$asLoginParams = array('action' => 'logincheck', 'controller' => 'login', 'module' => 'default');
		$asAddParams = array('action' => 'addedit', 'controller' => 'user', 'module' => 'default');
		$asListParams = array('action' => 'list', 'controller' => 'user', 'module' => 'default');
		...
		$this->request->setMethod('POST')
			->setPost(array('email' => 'shashank@gmail.com','password'=>'shashank','first_name'=>'sanjay','last_name'=>'Patel','city'=>'Rajkot'));
		
		$this->dispatch('/user/addedit');
	...
	public function testEditUserAction()
	{
		...
		$this->dispatch('/user/addedit?id=2');
	...
	{
		$asLoginParams = array('action' => 'logincheck', 'controller' => 'login', 'module' => 'default');
		$asDeleteParams = array('action' => 'delete', 'controller' => 'user', 'module' => 'default');
		$asListParams = array('action' => 'list', 'controller' => 'user', 'module' => 'default');
		...
		$this->dispatch('/user/delete?id=3');
